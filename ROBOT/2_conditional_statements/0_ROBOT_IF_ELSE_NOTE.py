...
1. In robot we can't create if block. If we want to run a block of code based on condition then we have to create a keyword with  block of code then we can run this keyword based on condition using "Run Keyword If"
